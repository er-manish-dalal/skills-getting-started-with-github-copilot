          ...
          details.participants.forEach((participant) => {
            participantsHTML += `
              <li class="participant-item">
                ...
                <button class="delete-participant-btn" title="Remove participant" data-activity="${encodeURIComponent(name)}" data-participant="${encodeURIComponent(participant)}">&#128465;</button>
              </li>
            `;
          });
        } else {
